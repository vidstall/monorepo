...
#[test_only]
module dvconf_role_voting::role_revote_events_tests {
    use sui::test_scenario::{Self as ts};
    use sui::bcs;
    use dvconf::registration_events;
...
use dvconf_role_voting::role_voting_events;
    ...
    fun test_role_transitioned_schema_and_bcs_layout() {
        ...
        let ev = registration_events::new_role_transitioned_for_testing(
    ...
    fun test_revote_eligible_marked_schema_and_bcs_layout() {
        ...
        let ev = role_voting_events::new_revote_eligible_marked_for_testing(
