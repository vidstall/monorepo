...
#[test_only]
module dvconf_role_voting::role_voting_governance_tests {
    ...
    use dvconf_role_voting::role_voting_governance;
    ...
    fun test_build_governance_msg_byte_layout_matches_fixture() {
        let msg_cd = role_voting_governance::build_governance_msg(1, 21, 0, 0);
        assert!(msg_cd == MSG_COOLDOWN, 0);
        let msg_mi = role_voting_governance::build_governance_msg(2, 45, 0, 0);
    ...
    fun test_update_cooldown_via_quorum_happy() {
        ...
        ts::next_tx(&mut scenario, h::admin());
        {
            ...
            role_voting_governance::update_revote_cooldown_epochs(
    ...
    fun test_update_max_idle_via_quorum_happy() {
        ...
        ts::next_tx(&mut scenario, h::admin());
        {
            ...
            role_voting_governance::update_max_idle_epochs(
                &net_reg, &mut vote_box, &cp_reg, &state,
    ...
    #[test]
    #[expected_failure(abort_code = 718, location = dvconf_role_voting::role_voting_governance)]
    ...
    #[test]
    #[expected_failure(abort_code = 700, location = dvconf_role_voting::role_voting_governance)]
