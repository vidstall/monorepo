...
#[test_only]
module dvconf_role_voting::role_voting_mark_tests {
    ...
    fun test_mark_composition_shift_succeeds_on_surplus_role() {
        ...
        ts::next_tx(&mut scenario, h::admin());
        {
            ...
            role_voting_revote::mark_revote_eligible_composition_shift(
                &net_reg,
                &mut vote_box,
                &store,
                &relay_reg,
    ...
    fun test_mark_miner_request_succeeds_with_cap() {
        ...
        ts::next_tx(&mut scenario, MINER_RELAY);
        {
            ...
            role_voting_revote::mark_revote_eligible_miner_request(
                &net_reg,
                &mut vote_box,
                &store,
                &cap,
    ...
    #[test]
    #[expected_failure(abort_code = role_voting::E_NOT_IDLE_YET, location = dvconf_role_voting::role_voting_revote)]
    ...
    #[test]
    #[expected_failure(abort_code = role_voting::E_COMPOSITION_NOT_IMBALANCED, location = dvconf_role_voting::role_voting_revote)]
    ...
    #[test]
    #[expected_failure(abort_code = role_voting::E_INVALID_CAP_OWNER, location = dvconf_role_voting::role_voting_revote)]
    fun test_mark_miner_request_aborts_with_wrong_cap_owner() {
        ...
        {
            let fake_cap = caps::new_miner_cap_for_testing(miner_id, constants::role_relay(), ts::ctx(&mut scenario));
