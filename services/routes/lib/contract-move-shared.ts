...
const FUNCTION_MODULES: Record<string, string> = {
  ...
  node_count: "worker_accessors",
  next_node_id: "worker_accessors",
  active_worker_count: "worker_accessors",
  worker_owner: "worker_accessors",
  worker_active: "worker_accessors",
  worker_rentable: "worker_accessors",
  worker_price_per_rental: "worker_accessors",
  worker_stake_value: "worker_accessors",
  worker_active_rental_id: "worker_accessors",
  worker_metadata_uri: "worker_accessors",
  worker_metadata_hash: "worker_accessors",
  worker_created_at_ms: "worker_accessors",
