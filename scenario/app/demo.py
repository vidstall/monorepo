...
def run(ctx: ScenarioContext) -> None:
    ...
    # Fund each wallet with 0.3 SUI for gas (stake amounts are tiny, gas dominates)
    ctx.fund_wallet(w1_addr, 300_000_000)
    ctx.fund_wallet(w2_addr, 300_000_000)
    ctx.fund_wallet(w3_addr, 300_000_000)
