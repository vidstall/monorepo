...
export function getRoutesEndpoint() {
  const explicitRoutesEndpoint = process.env.NEXT_PUBLIC_ROUTES_URL;
  if (explicitRoutesEndpoint) {
    return explicitRoutesEndpoint;
  }
